<?php
$Obj->name = "salida_mercaderias";
$Obj->alias = "Salida Directa de Inventario";
$Obj->help = "Salida Directa de Inventario";
$Obj->copy_from = "";
$Obj->Inheritance = "";
...
$Obj->Add(
    array(
        ...
        F_TYPE_ => "text",
        F_MAKE_QUERY_ => "1",
        F_QUERY_ => "'select gen_venta('+f_cli_cod.getVal()+','+f_cat.getVal()+','+f_usuario.getStr()+',4);'",
...
$Obj->Add(
    array(
        F_NAME_ => "f_gen",
        F_ALIAS_ => "Generar Salida",
        F_HELP_ => "Generar Salida",
        F_TYPE_ => "select_list",
        F_OPTIONS_ => "No,Si",
        F_NODB_ => "1",
        F_ORD_ => "46",
...
$Obj->Add(
    array(
        F_NAME_ => "f_det",
        F_ALIAS_ => "Detalle de Salida",
        F_HELP_ => "Detalle de Salida",
        F_TYPE_ => "subform",
...
$Obj->Add(
    array(
        ...
        F_ORD_ => "123",
        C_VIEW_ => "false",
        F_FORMULA_ => "if( !openSubform   ){  document.getElementById(|{cap`f_det`Detalle de Salida}|).click(); openSubform=true; }else{openSubform=false;  }",
        G_SHOW_ => "68",
        G_CHANGE_ => "68"));
...
$Obj->Add(
    array(
        F_NAME_ => "f_cerrar",
        F_ALIAS_ => "Cerrar Salida",
        F_HELP_ => "Cerrar Salida",
        F_TYPE_ => "proc",
        F_QUERY_ => "'update factura_venta set f_estado = |{Cerrada}| where f_nro = '+f_nro.getVal()",
        F_NODB_ => "1",
        F_ORD_ => "39",
        F_INLINE_ => "1",
        C_SHOW_ => "f_estado.get()=='Cerrada'",
        G_SHOW_ => "68",
        G_CHANGE_ => "68"));		
