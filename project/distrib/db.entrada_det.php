...
$Obj->Add(
    array(
        ...
        F_TYPE_ => "text",
        F_MAKE_QUERY_ => "1",
        F_QUERY_ => "'SELECT calc_stock('+p_cod_art.getStr()+')'",
        F_QUERY_REF_ => "operation==INSERT_&&p_cod_art.get()!=''&&p_cod_art.hasChanged()",
        F_LENGTH_ => "12",
		F_NODB_ => "1",
        F_DEC_ => "2",		
        F_ORD_ => "19",
...
$Obj->Add(
    array(
        ...
        F_BROW_ => "1",
        F_ORD_ => "60",
        F_FORMULA_ => "p_valor.getVal()  / p_cant_um.getVal() ",
        G_SHOW_ => "64",
        G_CHANGE_ => "64"));
