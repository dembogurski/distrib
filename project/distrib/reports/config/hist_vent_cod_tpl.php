<!-- 
    Report Template File (hist_vent_cod)
	  ...
	  <tbody>
		...
		<tr>
		  ...
		  <td style="text-align: center;"><big
			style="font-weight: bold;"><big>Historial de Ventas x Codigo: {sup_p_cod}</big></td>
		  <td style="text-align: right;">
...
<!-- begin: header0 -->
    <tr>
        ...
        <th>RUC</th>
        <th>Cliente</th>
        <th style="text-align: right;">CantV</th>
        <th>UM</th>
        <th>PrecioV</th>
    </tr>
</thead>
...
<!-- begin: query0_data_row -->
         <tr>
            ...
            <td class="num">{query0_PrecioV}</td>
         </tr>
<!-- end:    query0_data_row -->
...
<!-- begin: query0_subtotal_row -->
        <tr>
            ...
            <td></td>
            <td></td>
            <td style="text-align: right;font-size: 13"><b>{subtotal0_CantV}</b></td>
            <td></td>
            <td></td>
        </tr>
