...
$Obj->Add(
    array(
        ...
        F_TYPE_ => "text",
        F_MAKE_QUERY_ => "1",
        F_QUERY_ => "'select gen_venta('+f_cli_cod.getVal()+','+f_cat.getVal()+','+f_usuario.getStr()+');'",
...
$Obj->Add(
    array(
        ...
        F_FILTER_ => "'cli_ci like |{'+f_b_cli.get()+'%}| or cli_nombre like |{'+f_b_cli.get()+'%}| LIMIT 1' ",
        F_ORD_ => "30",
        F_INLINE_ => "1",
        V_DEFAULT_ => "1",
        G_SHOW_ => "64",
...
$Obj->Add(
    array(
        ...
        F_HELP_ => "Imprimir Factura Legal",
        F_TYPE_ => "report",
        F_REPORT_ => "rep.imprimir_factura_legal",
        F_NODB_ => "1",
        F_ORD_ => "44",
        F_INLINE_ => "1",
        C_SHOW_ => "operation==CHANGE_&&f_estado.get()=='Cerrada'",
        G_SHOW_ => "64",
        G_CHANGE_ => "64"));		
